...
const GET_USER_QUERY: &str = "SELECT wallet_address, starting_balance, current_balance, total_realized_pnl, created_at FROM paper_trading.users WHERE wallet_address = ?";
